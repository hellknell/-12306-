...
public class DailyTrainTicketController {
    ...
    @Operation(summary = "查询每日车票2")
    @GetMapping("/query-list-2")
    public Result<PageInfo<DailyTrainTicketQueryResp>> queryList2(@Valid DailyTrainTicketQueryReq req) {
        return Result.success(dailyTrainTicketService.queryList2(req));
    }
